...
export default {
  ...
  settings: {
    ...
    channels: {
      ...
      autoActivationDesc:
        "When on, confirmations are sent only to the active maintained channel instead of every configured channel.",
      ...
      autoActivationChannelsHint:
        "Enable it under Advanced to avoid duplicate confirmation delivery.",
      autoEndWatchTitle: "Auto-stop watches when the active channel switches",
      autoEndWatchDesc:
        "When on, watches stop after the active maintained channel changes. Only effective when On-demand IM delivery is enabled.",
